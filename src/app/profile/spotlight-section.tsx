      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-soft">
            Optional. Let Heal feature you as an IESP Solutions Builder.
            This has no effect on your program or certificate, and you can
            withdraw anytime.
          </p>
        </div>
...
function ConsentBlock({
  ...
  const role = initial?.headline || "Solutions Builder";
  ...
  return (
    <div className="mt-6 rounded-2xl border border-surface-muted bg-surface-subtle p-5">
      ...
      <ul className="mt-3 space-y-1.5 text-sm text-ink-soft">
        ...
        <li>• <strong>It&apos;s optional:</strong> it won&apos;t affect your program or certificate.</li>
      ...
      <div className="mt-4">
        ...
        <div className="rounded-2xl border border-surface-muted bg-white p-4 shadow-card">
          <div className="flex items-center gap-3">
            ...
            <span className="ml-auto text-xs text-ink-muted">via Heal IESP</span>
          </div>
          {initial?.quote && (
          ...
          <p className="mt-3 text-xs text-ink-muted">
            🎓 Featured as a Heal IESP Solutions Builder
          </p>
        </div>
