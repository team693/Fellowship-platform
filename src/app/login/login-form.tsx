...
export function LoginForm() {
  ...
  const redirectBase = `${env.siteUrl()}/auth/confirm?next=${encodeURIComponent(next)}`;
  ...
  if (status === "sent") {
    return (
      <div className="mt-6 rounded-xl border border-mint-200 bg-mint-50 p-4 text-sm text-mint-800">
  ...
  return (
    <div className="mt-6 space-y-4">
      ...
      <button onClick={signInWithGoogle} className="btn-ghost w-full py-3">
        <GoogleIcon />
