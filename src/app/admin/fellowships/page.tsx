...
export default async function AdminFellowshipsPage() {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
      <div>
        <h1 className="text-2xl font-extrabold">Fellowships</h1>
        <p className="mt-1 text-ink-soft">Create fellowships and manage their modules.</p>
        ...
        <div className="mt-6 space-y-3">
          ...
          {fellowships.length === 0 && (
            <div className="card text-center text-ink-muted">No fellowships yet.</div>
          )}
        </div>
      </div>
      ...
      <aside>
        <div className="card">
          <h2 className="text-lg font-bold">New fellowship</h2>
